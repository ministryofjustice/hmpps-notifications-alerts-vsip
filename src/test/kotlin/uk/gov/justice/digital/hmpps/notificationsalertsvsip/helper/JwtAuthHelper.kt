package uk.gov.justice.digital.hmpps.notificationsalertsvsip.helper
...
class JwtAuthHelper {
  ...
  fun setAuthorisation(
    user: String = "hmpps-notifications-alerts-vsip",
  ...
  internal fun createJwt(
    ...
    .also { it["client_id"] = "hmpps-notifications-alerts-vsip" }
