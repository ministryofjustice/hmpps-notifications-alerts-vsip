...
data class SendEmailNotificationDto(
  @param:Schema(description = "Name of gov notify template to use", required = true)
  val templateName: String,
  @param:Schema(description = "Map of gov notify template personalisations", required = true)
