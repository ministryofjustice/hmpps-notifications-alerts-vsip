...
const val PRISON_VISIT_REQUEST_ACTIONED = "prison-visit-request.actioned"

@Component(value = PRISON_VISIT_REQUEST_ACTIONED)
class PrisonVisitRequestActionedEventNotifier(
  ...
  override fun processEvent(domainEvent: DomainEvent) {
    ...
    notificationService.sendMessage(VisitEventType.REQUEST_ACTIONED, visitAdditionalInfo)
  }
}
